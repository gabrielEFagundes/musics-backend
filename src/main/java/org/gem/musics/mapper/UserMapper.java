...
public class UserMapper {
    ...
    public User toEntity(UserRequest req){
        return new User(req.name(), req.email(), req.password(), req.profilePictureUrl());
    }

    public UserResponse toResponse(User u){
        return new UserResponse(u.getId(), u.getName(), u.getEmail(), u.getPassword(), u.getLoginDate(), u.getProfilePictureUrl());
    }
